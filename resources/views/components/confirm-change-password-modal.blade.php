<div id="confirm-change-password-modal" class="fixed z-10 inset-0 overflow-y-auto hidden">
            ...
            <div class="sm:flex sm:items-start">
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="flex flex-col mt-1 gap-4">
                  ...
                  <input name="currentPassword" class="h-10 w-full rounded-md border border-[#E5E5E5] bg-[#FFFFFF] px-3 py-2 text-sm ring-offset-[#FFFFFF] placeholder:text-[#737373] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" type="text">
                </div>
              </div>
            </div>
          </div>
          <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <button type="submit" id="submit-confirm-change-password-modal" class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-[#2563EB] text-base font-medium text-white hover:bg-[#2563EB]/90 focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] focus-visible:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm">
                Submit
              </button>
