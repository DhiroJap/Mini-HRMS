...
<div id="edit-profile-content" class="flex-1 lg:max-w-2xl">
    <div class="space-y-6">
        ...
        <form id="edit-form-profile" action="{{route('updateProfile')}}" method="POST" class="space-y-8" enctype="multipart/form-data">
            ...
            <!-- <div class="space-y-2">
                ...
                <div class="block items-center sm:flex">
                    <div class="shrink-0 h-28 w-28 rounded-full bg-gray-200 border-solid border-gray-300 border-2 mb-4 flex items-center justify-center relative overflow-hidden mr-4">
                        <img src="images/{{$user->avatar}}" class="object-cover w-full h-full rounded-full border-0" id="img-container">
                    </div>
            ...
            <div class="space-y-2">
                <label for="edit-avatar" id="avatar" class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Avatar</label>
