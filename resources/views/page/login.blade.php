...
<div class="flex flex-col min-h-screen items-center justify-center lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-lg">
        <form class="space-y-2" action="#" method="POST">
            ...
            <div>
                <button type="submit" class="flex w-full justify-center rounded-md font-semibold bg-blue-600 px-3 py-2.5 text-lg leading-6 text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Login</button>
            </div>
        </form>
